...
import numpy as np
import scr.SamplePathClass as Cls
...
class Cohort:
    ...
    def get_survival_percentage(self):

        for obs in self.get_survival_times():
            if obs >= 5:
                self._fiveYears =+ 1

        return self._fiveYears / self._initialPopSize
...
class CohortOutcomes:
    ...
    def get_survival_curve(self):
        ...
        n_living_patients = Cls.SamplePathBatchUpdate('# of living patients', 0, n_pop)
    ...
    def get_survival_percentage(self):
        ...
        return self._simulatedCohort.get_survival_percentage()




Group = Cohort(1, 573, 0.5)

print('Percentage of patients survived beyond 5 years in a cohort of 573 patients:', Group.get_survival_percentage())

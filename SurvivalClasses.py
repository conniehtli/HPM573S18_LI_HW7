...
class Cohort:
    ...
    def simulate(self, n_time_steps):
        ...
        for obs in self.get_survival_times():
            ...
            no = 0
            if obs > 5:
                self._survivePastFiveList.append(yes)
            else:
                self._survivePastFiveList.append(no)
    ...
    def get_survival_five_years(self):

        return self._survivePastFiveList
...
class CohortOutcomes:
    def __init__(self, simulated_cohort):
        ...
        self._sumStat_patientFiveYears = \
            Stat.SummaryStat('Patients still alive after five years', self._simulatedCohort.get_survival_five_years())
    ...
    def get_survival_after_five(self):

        return self._sumStat_patientFiveYears.get_mean()
...
class MultiCohort:
    ...
    def __init__(self, ids, pop_sizes, mortality_probs):
        ...
        self._survivePastFiveList = []
        self._all_survivalProb_after_five = []
    ...
    def simulate(self, n_time_steps):
        ...
        for i in range(len(self._ids)):
            ...
            self._survivePastFiveList.append(cohort.get_survival_five_years())
            self._all_survivalProb_after_five.append(output.get_survival_after_five())
        ...
        self._sumStat_afterFive = Stat.SummaryStat('Mean proportion of patients that survive past 5 years', self._all_survivalProb_after_five)
...
#individual cohort
    ...
    def get_cohort_mean_fiveYear_survival(self, cohort_index):
        return self._all_survivalProb_after_five[cohort_index]

    def get_cohort_CI_mean_fiveYear(self, cohort_index, alpha):
        st2 = Stat.SummaryStat('', self._survivePastFiveList[cohort_index])
...
#multicohort
    ...
    def get_all_fiveYear_survival_proportion(self):
        return self._all_survivalProb_after_five

    def get_mean_fiveYear_survival_proportion(self):
        return self._sumStat_afterFive.get_mean()
    ...
    def get_cohort_PI_mean_fiveYear_survival(self, cohort_index, alpha):
        st3 = Stat.SummaryStat('', self._all_survivalProb_after_five[cohort_index])
        return st3.get_PI(alpha)

    def get_PI_mean_fiveYear_survival(self, alpha):
        return self._sumStat_afterFive.get_PI(alpha)